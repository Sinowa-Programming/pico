...
// Device descriptor.
// For a vendor device ths is simple. DeviceClass is 0xff and SubClass and
...
uint8_t static desc_configuration[] = {
    ...
    TUD_CONFIG_DESCRIPTOR(1, ITF_NUM_VIDEO, 0, CONFIG_TOTAL_LEN, 0x80, 100),

    TUD_VENDOR_DESCRIPTOR(ITF_NUM_VIDEO, 0, EPNUM_VIDEO_OUT, EPNUM_VIDEO_IN, ENDPOINT_BULK_SIZE),
};
