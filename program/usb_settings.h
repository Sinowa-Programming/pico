...
#define EXAMPLE_PID 0x4010

// Maximum packet sizes for the endpoints.  64 for fullspeed
#define MAX_ENDPOINT0_SIZE  64
#define ENDPOINT_BULK_SIZE  64

// Strings for the USB device descriptor
#define MANUFACTURER  "sinowa.tst"
#define PRODUCT       "VP9 Decoder"
#define SERIAL        "000"
...
#define EPNUM_VIDEO_OUT     0x01
#define EPNUM_VIDEO_IN      0x81 // 0x80 | 0x01

// Interface number (only one for now)
#define ITF_NUM_VIDEO     0
